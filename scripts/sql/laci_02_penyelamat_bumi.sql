...
BEGIN 
  ...
  SELECT id INTO v_profile_id FROM profiles_warga_demo1 WHERE slug = 'farwiza-farhan' LIMIT 1;
...
BEGIN 
  -- Check if profile exists by slug
  SELECT id INTO v_profile_id FROM profiles_warga_demo1 WHERE slug = 'm-bijaksana-junerosano' LIMIT 1;
...
BEGIN 
  -- Check if profile exists by slug
  SELECT id INTO v_profile_id FROM profiles_warga_demo1 WHERE slug = 'mbah-sadiman' LIMIT 1;
...
BEGIN 
  -- Check if profile exists by slug
  SELECT id INTO v_profile_id FROM profiles_warga_demo1 WHERE slug = 'silverius-oscar-unggul' LIMIT 1;
...
BEGIN 
  -- Check if profile exists by slug
  SELECT id INTO v_profile_id FROM profiles_warga_demo1 WHERE slug = 'prigi-arisandi' LIMIT 1;
...
BEGIN 
  -- Check if profile exists by slug
  SELECT id INTO v_profile_id FROM profiles_warga_demo1 WHERE slug = 'swietenia-puspa-lestari' LIMIT 1;
...
BEGIN 
  -- Check if profile exists by slug
  SELECT id INTO v_profile_id FROM profiles_warga_demo1 WHERE slug = 'david-christian' LIMIT 1;
...
BEGIN 
  -- Check if profile exists by slug
  SELECT id INTO v_profile_id FROM profiles_warga_demo1 WHERE slug = 'mohammad-baedowy' LIMIT 1;
...
BEGIN 
  -- Check if profile exists by slug
  SELECT id INTO v_profile_id FROM profiles_warga_demo1 WHERE slug = 'i-gede-robi-supriyanto' LIMIT 1;
...
BEGIN 
  -- Check if profile exists by slug
  SELECT id INTO v_profile_id FROM profiles_warga_demo1 WHERE slug = 'andrew-kalaweit' LIMIT 1;
