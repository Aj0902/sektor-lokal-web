...
BEGIN 
  ...
  SELECT id INTO v_profile_id FROM profiles_warga_demo1 WHERE slug = 'carina-joe' LIMIT 1;
...
BEGIN 
  -- Check if profile exists by slug
  SELECT id INTO v_profile_id FROM profiles_warga_demo1 WHERE slug = 'griselda-sastrawinata' LIMIT 1;
...
BEGIN 
  -- Check if profile exists by slug
  SELECT id INTO v_profile_id FROM profiles_warga_demo1 WHERE slug = 'iko-uwais' LIMIT 1;
...
BEGIN 
  -- Check if profile exists by slug
  SELECT id INTO v_profile_id FROM profiles_warga_demo1 WHERE slug = 'joey-alexander' LIMIT 1;
...
BEGIN 
  -- Check if profile exists by slug
  SELECT id INTO v_profile_id FROM profiles_warga_demo1 WHERE slug = 'muhammad-arief-budiman' LIMIT 1;
...
BEGIN 
  -- Check if profile exists by slug
  SELECT id INTO v_profile_id FROM profiles_warga_demo1 WHERE slug = 'niki-zefanya' LIMIT 1;
...
BEGIN 
  -- Check if profile exists by slug
  SELECT id INTO v_profile_id FROM profiles_warga_demo1 WHERE slug = 'adi-utarini' LIMIT 1;
...
BEGIN 
  -- Check if profile exists by slug
  SELECT id INTO v_profile_id FROM profiles_warga_demo1 WHERE slug = 'prof-ken-soetanto' LIMIT 1;
...
BEGIN 
  -- Check if profile exists by slug
  SELECT id INTO v_profile_id FROM profiles_warga_demo1 WHERE slug = 'rich-brian' LIMIT 1;
...
BEGIN 
  -- Check if profile exists by slug
  SELECT id INTO v_profile_id FROM profiles_warga_demo1 WHERE slug = 'william-wongso' LIMIT 1;
