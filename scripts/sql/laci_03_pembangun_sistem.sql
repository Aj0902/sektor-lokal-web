...
BEGIN 
  ...
  SELECT id INTO v_profile_id FROM profiles_warga_demo1 WHERE slug = 'onno-w-purbo' LIMIT 1;
...
BEGIN 
  -- Check if profile exists by slug
  SELECT id INTO v_profile_id FROM profiles_warga_demo1 WHERE slug = 'warsito-p-taruno' LIMIT 1;
...
BEGIN 
  -- Check if profile exists by slug
  SELECT id INTO v_profile_id FROM profiles_warga_demo1 WHERE slug = 'ainun-najib' LIMIT 1;
...
BEGIN 
  -- Check if profile exists by slug
  SELECT id INTO v_profile_id FROM profiles_warga_demo1 WHERE slug = 'khoirul-anwar' LIMIT 1;
...
BEGIN 
  -- Check if profile exists by slug
  SELECT id INTO v_profile_id FROM profiles_warga_demo1 WHERE slug = 'jim-geovedi' LIMIT 1;
...
BEGIN 
  -- Check if profile exists by slug
  SELECT id INTO v_profile_id FROM profiles_warga_demo1 WHERE slug = 'ayu-purwarianti' LIMIT 1;
...
BEGIN 
  -- Check if profile exists by slug
  SELECT id INTO v_profile_id FROM profiles_warga_demo1 WHERE slug = 'irzan-raditya' LIMIT 1;
...
BEGIN 
  -- Check if profile exists by slug
  SELECT id INTO v_profile_id FROM profiles_warga_demo1 WHERE slug = 'romi-satria-wahono' LIMIT 1;
...
BEGIN 
  -- Check if profile exists by slug
  SELECT id INTO v_profile_id FROM profiles_warga_demo1 WHERE slug = 'sunu-wibirama' LIMIT 1;
...
BEGIN 
  -- Check if profile exists by slug
  SELECT id INTO v_profile_id FROM profiles_warga_demo1 WHERE slug = 'yohanes-surya' LIMIT 1;
