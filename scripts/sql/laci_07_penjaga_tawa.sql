...
BEGIN 
  ...
  SELECT id INTO v_profile_id FROM profiles_warga WHERE slug = 'pandji-pragiwaksono' LIMIT 1;
...
BEGIN 
  -- Check if profile exists by slug
  SELECT id INTO v_profile_id FROM profiles_warga WHERE slug = 'arie-kriting' LIMIT 1;
...
BEGIN 
  -- Check if profile exists by slug
  SELECT id INTO v_profile_id FROM profiles_warga WHERE slug = 'abdur-arsyad' LIMIT 1;
...
BEGIN 
  -- Check if profile exists by slug
  SELECT id INTO v_profile_id FROM profiles_warga WHERE slug = 'bintang-emon' LIMIT 1;
...
BEGIN 
  -- Check if profile exists by slug
  SELECT id INTO v_profile_id FROM profiles_warga WHERE slug = 'mamat-alkatiri' LIMIT 1;
...
BEGIN 
  -- Check if profile exists by slug
  SELECT id INTO v_profile_id FROM profiles_warga WHERE slug = 'sadana-agung-sulistya' LIMIT 1;
...
BEGIN 
  -- Check if profile exists by slug
  SELECT id INTO v_profile_id FROM profiles_warga WHERE slug = 'bene-dion-rajagukguk' LIMIT 1;
...
BEGIN 
  -- Check if profile exists by slug
  SELECT id INTO v_profile_id FROM profiles_warga WHERE slug = 'yono-bakrie' LIMIT 1;
...
BEGIN 
  -- Check if profile exists by slug
  SELECT id INTO v_profile_id FROM profiles_warga WHERE slug = 'nopek-novian' LIMIT 1;
...
BEGIN 
  -- Check if profile exists by slug
  SELECT id INTO v_profile_id FROM profiles_warga WHERE slug = 'dustin-tiffani' LIMIT 1;
