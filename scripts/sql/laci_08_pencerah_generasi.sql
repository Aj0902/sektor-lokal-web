...
BEGIN 
  ...
  SELECT id INTO v_profile_id FROM profiles_warga WHERE slug = 'ferry-irwandi' LIMIT 1;
...
BEGIN 
  -- Check if profile exists by slug
  SELECT id INTO v_profile_id FROM profiles_warga WHERE slug = 'najwa-shihab' LIMIT 1;
...
BEGIN 
  -- Check if profile exists by slug
  SELECT id INTO v_profile_id FROM profiles_warga WHERE slug = 'gita-wirjawan' LIMIT 1;
...
BEGIN 
  -- Check if profile exists by slug
  SELECT id INTO v_profile_id FROM profiles_warga WHERE slug = 'kalis-mardiasih' LIMIT 1;
...
BEGIN 
  -- Check if profile exists by slug
  SELECT id INTO v_profile_id FROM profiles_warga WHERE slug = 'gerald-sebastian' LIMIT 1;
...
BEGIN 
  -- Check if profile exists by slug
  SELECT id INTO v_profile_id FROM profiles_warga WHERE slug = 'heni-sri-sundani' LIMIT 1;
...
BEGIN 
  -- Check if profile exists by slug
  SELECT id INTO v_profile_id FROM profiles_warga WHERE slug = 'angga-fauzan' LIMIT 1;
...
BEGIN 
  -- Check if profile exists by slug
  SELECT id INTO v_profile_id FROM profiles_warga WHERE slug = 'alanda-kariza' LIMIT 1;
...
BEGIN 
  -- Check if profile exists by slug
  SELECT id INTO v_profile_id FROM profiles_warga WHERE slug = 'felicia-putri-tjiasaka' LIMIT 1;
...
BEGIN 
  -- Check if profile exists by slug
  SELECT id INTO v_profile_id FROM profiles_warga WHERE slug = 'dr-indrawan-nugroho' LIMIT 1;
